...
let {cookBeans, steamBroccoli, cookRice, bakeChicken} = require('./HandlingIndependetPromises-Library.js');
...
async function serveDinner(){
  ...
  const protienPromise = bakeChicken();
  const sidePromise = cookBeans();

  const sidePromiseObject = cookBeans;
